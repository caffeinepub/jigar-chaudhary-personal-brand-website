...
function FadeIn({
  ...
  const [ref, inView] = useInView<HTMLDivElement>({ once: true, rootMargin: '-60px' });
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
          ...
          <FadeIn direction="right" delay={100}>
            <p className="font-body text-lg md:text-xl text-brand-light/90 leading-relaxed mb-6 font-light">
              <span className="text-brand-orange font-semibold">Jigar Chaudhary</span> is one of India's youngest experiential facilitators — a Youth Trainer, Motivational Speaker, and Workshop Designer who believes{' '}
              <span className="text-brand-gold italic">learning must be felt, not just heard.</span>
            </p>
            <p className="font-body text-base md:text-lg text-brand-light/70 leading-relaxed mb-8">
              With 130+ sessions conducted across colleges, universities, and institutions, Jigar has impacted thousands of young minds through immersive, high-energy experiences that create real, lasting transformation.
            </p>
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                <div key={trait} className="flex items-center gap-3">
                  ...
                  <span className="font-body text-sm text-brand-light/80">{trait}</span>
                </div>
              ))}
            </div>
          </FadeIn>
