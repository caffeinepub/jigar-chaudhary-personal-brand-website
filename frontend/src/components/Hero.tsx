      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pt-24 pb-16 flex flex-col lg:flex-row items-center justify-between gap-8 min-h-screen">
        ...
        <div className="flex-1 text-center lg:text-left max-w-2xl">
          ...
          >
            ...
            <span>Grow.</span>{' '}
            <span className="text-brand-gold">Lead.</span>
          </h1>
          ...
          >
            <span className="text-brand-orange font-semibold">Jigar Chaudhary</span> — India's Boldest Youth Trainer &amp; Experiential Facilitator
          </p>
            ...
            {stats.map((stat) => (
              <div key={stat.label} className="text-center lg:text-left">
                <div className="font-display text-4xl md:text-5xl text-brand-orange leading-none mb-1">
                  <CounterAnimation target={stat.value} suffix={stat.suffix} duration={2200} />
                </div>
        ...
        {/* Right: Jigar's photo — ws4.jpeg circular headshot with headset mic */}
        <div
