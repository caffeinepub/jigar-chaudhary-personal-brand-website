...
import { MessageCircle, Mail, MapPin, Send, CheckCircle2, Phone, Loader2 } from 'lucide-react';
...
export default function Contact() {
  ...
  const [formRef, formInView] = useInView<HTMLDivElement>({ once: true, rootMargin: '-40px' });
  const [infoRef, infoInView] = useInView<HTMLDivElement>({ once: true, rootMargin: '-40px' });
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/916351622776?text=Hi%20Jigar%2C%20I%20would%20like%20to%20book%20a%20session.', '_blank');
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full py-16 text-center">
                ...
                <h3 className="font-display text-4xl text-brand-light mb-3">Booking Request Sent!</h3>
                <p className="font-body text-brand-muted text-base">
                  Your booking request has been sent! Jigar's team will get back to you within 24 hours.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="font-body text-xs text-brand-muted tracking-wide uppercase block mb-1.5">
                      Name *
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  >
                    ...
                    {eventTypes.map((type) => (
                      <option key={type} value={type} className="bg-brand-dark-card">
                        {type}
                      </option>
                    ))}
                  </select>
          ...
          >
            ...
            <div className="flex items-center gap-4 bg-brand-dark-card border border-white/5 rounded-sm p-5">
              ...
              <div>
                <div className="font-body text-xs text-brand-muted tracking-wide uppercase mb-0.5">Phone</div>
                <a
            ...
            <div className="flex items-center gap-4 bg-brand-dark-card border border-white/5 rounded-sm p-5">
              ...
              <div>
                <div className="font-body text-xs text-brand-muted tracking-wide uppercase mb-0.5">Email</div>
                <a
            ...
            <div className="flex items-center gap-4 bg-brand-dark-card border border-white/5 rounded-sm p-5">
              ...
              <div>
                <div className="font-body text-xs text-brand-muted tracking-wide uppercase mb-0.5">Location</div>
            ...
            <div className="bg-brand-dark-card border border-white/5 rounded-sm p-5">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <SiInstagram size={16} className="text-brand-muted group-hover:text-brand-orange transition-colors duration-200" />
                </a>
                <a
                  ...
                  aria-label="LinkedIn"
                >
                  <SiLinkedin size={16} className="text-brand-muted group-hover:text-brand-orange transition-colors duration-200" />
                </a>
                <a
                  ...
                  aria-label="YouTube"
                >
                  <SiYoutube size={16} className="text-brand-muted group-hover:text-brand-orange transition-colors duration-200" />
                </a>
              </div>
            </div>
            ...
            <div className="border border-brand-orange/20 bg-brand-orange/5 rounded-sm p-5">
              <p className="font-body text-sm text-brand-light/80 leading-relaxed">
                <span className="text-brand-orange font-semibold">Currently accepting bookings</span> for college events, corporate workshops, and youth conferences across India.
              </p>
            </div>
          </div>
        </div>
