          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-white/5">
              ...
              <p className="font-body text-brand-light/70 text-base leading-relaxed mb-8">
                Corporate sessions designed for leadership, communication, team
                dynamics, and high-performance mindset. Jigar's experiential
                approach ensures your team doesn't just learn — they transform.
              </p>
              <button
                type="button"
